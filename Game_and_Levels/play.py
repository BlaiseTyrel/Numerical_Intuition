...
class Play:
    ...
    def run(self):
        ...
        self.play_button, self.level_button, self.back_button = load_buttons("play", 'level', 'back')
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                elif self.level_button.is_clicked(pos):
                    self.gamestatemanager.set_state('level')

        self.play_button.draw(self.display)
        self.level_button.draw(self.display)
