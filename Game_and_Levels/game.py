...
class MainGame:
    def __init__(self, display, gamestatemanager):
        ...
        self.designleft_image = pygame.image.load('Game Images/Game Paw.png')
        self.designright_image = pygame.image.load('Game Images/Game Paw 1.png')
    ...
    def run(self):
        ...
        if self.start_message:
            ...
            if remaining_time == 0:
                ...
                high_score = self.highscore_db.get_highscore()

                if current_score > high_score:
                    self.highscore_db.insert_score(current_score)
